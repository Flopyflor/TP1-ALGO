...
\begin{proc}{redistribucionDeLosFrutos}{\In recursos: \TLista{\float}, \In cooperan: \TLista{\bool}}{\TLista{\float}}
	...
	\asegura{|result| = |recursos| \yLuego \paraTodo{i}{\ent}{0 <= i \le |result| \implicaLuego \IfThenElse{cooperan[i] = \True}{result[i] = \frac{fondoComun(recursos, cooperan)}{\longitud{recursos}}}{result[i] = recursos[i] + \frac{fondoComun(recursos, cooperan)}{\longitud{recursos}}}}} 
\end{proc}
