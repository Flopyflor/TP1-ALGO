...
\begin{enumerate} \setlength\itemsep{4mm}
	...
	\vspace{2mm}
	\textbf{(Asumo que vale ($I \wedge B \wedge Fv= v_0$))}\\
	\vspace{2mm}
	$True\wedge True \wedge |eventos|-i = v_0 \implica True \wedge$ $|eventos|-i-1<v_0$ $\equiv$ \\
	\vspace{2mm}
	\textbf{(Reemplazo a $v_0$ por Fv ya que asumimos que vale)}\\
	\vspace{2mm}
	$|eventos|-i = v_0 \implica |eventos|-i-1<|eventos|-i$ $\equiv$ \\
	\vspace{2mm}
...
$P \implicaLuego wp(S,Q) \equiv P\implicaLuego wp(S1,S2,S3,Q)$$ \equiv$\\
$P\implicaLuego wp(S1,S2,wp(S3,Q)) \equiv P\implicaLuego wp(S1,S2,PC) \equiv P\implicaLuego wp(S1,wp(S2,PC)) $\\
\vspace{3mm}
...
\vspace{2mm}
\textbf{Ahora ya sabiendo cuanto vale wp(S,Q) podemos probar la validez de \{ P \}S\{ Q \}, es decir, que $P \implicaLuego wp(S,Q)$ vale.} \\
\vspace{2mm}
$P \implicaLuego wp(S,Q)$ $\equiv$\\
\vspace{2mm}
$P \implicaLuego True$\\
\vspace{2mm}
