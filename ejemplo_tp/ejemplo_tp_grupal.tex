...
\aux{TasasDeCooperadores}{turno: \ent, cooperan: \TLista{\bool}, pagos: \TLista{\TLista{\float}}, apuestas: \TLista{\TLista{\float}}}{}{
	\\ \sum\limits_{i=0}^{|cooperan|-1}{\IfThenElse{cooperan[i] = \True}{\frac{pagos[i][evento[i][turno]]*apuestas[i][evento[i][turno]]}{|cooperan|}}{0}}
}
