...
\begin{proc}{redistribucionDeLosFrutos}{\In recursos: \TLista{\float}, \In cooperan: \TLista{\bool}}{\TLista{\float}}
	...
	\asegura{|\res| = |recursos| \yLuego \\ \paraTodo{i}{\ent}{0 \leq i < |\res| \implicaLuego \IfThenElse{cooperan[i] = \True}{res[i] = \frac{fondoComun(recursos, cooperan)}{\longitud{recursos}}}{res[i] = recursos[i] + \frac{fondoComun(recursos, cooperan)}{\longitud{recursos}}}}} 
\end{proc}
...
\pred{todosElementosDeLasListasPositivos}{pagos: \TLista{\TLista{\float}}}{
     \paraTodo[unalinea]{i}{\ent}{\paraTodo[unalinea]{t}{\ent}{0 \leq i<|pagos| \land 0\leq t <|pagos[i]|} \implicaLuego pagos[i][j] \geq 0}
}

% TODO: pred eventosValidos (indices válidos para pagos)
...
% TODO: revisar el paratodo el tema de mayor o menor igual creo que en vez de \land 0 < t \le |eventos[0]|
% seria 0 \le t <|eventos [0]
...
{\float}{\\
	...
	% TODO:  cual prefieren? \times o *? lo cambie por *
