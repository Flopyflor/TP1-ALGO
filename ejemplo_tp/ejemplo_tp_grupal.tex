...
\begin{proc}{individuoActualizaApuesta}{\In individuo: \nat, \In recursos: \TLista{\float} , \In cooperan: \TLista{\bool} , 
	...
	dineroFinal(recursos , 	cooperan , apuestas , pagos , eventos)  \\
	\geq dineroFinal(recursos , cooperan , s , pagos , eventos)}
	}


\end{proc}

\aux{dineroFinal}{recursos: \TLista{\float} , cooperan: \TLista{\bool}, apuestas: \TLista{\TLista{\float}} , pagos: \TLista{\TLista{\float}} , eventos: \TLista{\TLista{\nat}}}{\float} {
