...
\[f_0 = r_c *t_0\] 
caso 1:\\ %TODO este caso creo que no hace falta ponerlo
\[f_1 = r_c *\prod\limits_{k=0}^{1}{t_k}\]
\[f_1 = r_c *\prod\limits_{k=0}^{1}{t_k}\] %TODO ya dije q este paso lo sacaría, pero si lo querés dejar, esto no es demostración suficiente
